...
if [  $type = "1"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/j0p1gnahrhwqp4u/bluepanelpremsetup.zip?dl=0"
elif [  $type = "2"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/efw9wlrumitn215/bluepanevipsetup.zip?dl=0"
elif [  $type = "3"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/46wfr27dg562ay5/bluepanelprivatesetup.zip?dl=0"
elif [  $type = ""  ]; then
      exit
fi
